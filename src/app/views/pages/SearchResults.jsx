                  ...
                  <ul className="list-group list-group-flush">
                    <li className="list-group-item">
                      ...
                      <p>
                        ...
                        Voluptate, minima autem quam exercitationem eos,
                        obcaecati aperiam delectus quia sapiente, deserunt quis
                        atque dolorem ducimus recusandae perspiciatis mollitia
                        excepturi ea rerum?
                      </p>
                    </li>
                    <li className="list-group-item">

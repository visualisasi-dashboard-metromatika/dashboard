                    ...
                    <div className="timeline-card card">
                      <div className="card-body">
                        ...
                        <p>
                          ...
                          elit. Modi dicta beatae illo illum iusto iste mollitia
                          explicabo quam officia. Quas ullam, quisquam
                          architecto aspernatur enim iure debitis dignissimos
                          suscipit ipsa.
                        </p>
                        <div className="mb-3">
                          <span className="mr-1">Like</span>
                  ...
                  <li className="timeline-item">
                    ...
                    <div className="timeline-card card">
                      <div className="card-body">
                        ...
                        <p>
                          <Link to="/">Henry krick</Link> and 16 others followed
                          you
                        </p>
                        <div className="mb-3">
                          <span className="mr-1">Like</span>

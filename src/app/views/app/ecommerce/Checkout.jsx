                  ...
                  <div className="col-lg-12 mt-5">
                    <div className="ul-product-cart__invoice">
                      <div className="card-title">
                        <h4 className="heading text-primary">Total Payment</h4>
                      </div>
                      <table className="table">
                        <tbody>
                          <tr>
            ...
            <div className="card mt-4">
              <div className="card-body">
                ...
                <Tabs defaultActiveKey="card">
                  <Tab
                    eventKey="card"
                    title={customTabHeader("Credit Card", "i-Credit-Card")}
                  >
                    <div className="row">
                      <div className="form-group col-md-6">
                        <label for="inputtext11" className="ul-form__label">
                  ...
                  <Tab
                    eventKey="paypal"
                    title={customTabHeader("Paypal", "i-Money-2")}
                  >
                    <div className="row">
                      <div className="form-group col-md-6">
                        <label for="inputtext11" className="ul-form__label">
                  ...
                  <Tab
                    eventKey="bitcoin"
                    title={customTabHeader("Bitcoin", "i-Bitcoin")}
                  >
                    <div className="row">
                      <div className="form-group col-md-6">
                        <label for="inputtext11" className="ul-form__label">

      ...
      <div className="row mb-4">
                ...
                <tbody>
                  {newUserList.map((user, index) => (
                    <tr key={index}>
                      ...
                      <td>
                        <span
                          className={`badge ${getUserStatusClass(user.status)}`}
                        >
                          {user.status}
                        </span>
                      </td>
        ...
        <div className="col-md-6 mb-3">
          <SimpleCard title="Basic Dark Table">
            <div className="table-responsive">
              <table id="user_table" className="table table-dark  text-center">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Name</th>
        ...
        <div className="col-md-6 mb-3">
          <SimpleCard title="light table head">
            <p>
              ...
              <code>.thead-light</code> to make <code>thead</code> appear light
            </p>
            <div className="table-responsive">
              <table id="user_table" className="table  text-center">
                <thead>
      ...
      <div className="row mb-4">
        <div className="col-md-6 mb-3">
          <SimpleCard title="Light hoverable Table">
            ...
            <div className="table-responsive">
              <table id="user_table" className="table table-hover  text-center">
                <thead>
                  <tr>
                    <th scope="col">#</th>
                    <th scope="col">Name</th>
        ...
        <div className="col-md-6 mb-3">
          <SimpleCard title="Dark Table With Background">
            <p>
              ...
              table, however, you may use text or background utilities to

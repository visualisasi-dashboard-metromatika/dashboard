                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="form-group col-md-6">
                        <label htmlFor="inputEmail1" className="ul-form__label">
                          Full Name:
                        </label>
                        <input
                          type="text"
                      ...
                      <div className="form-group col-md-6">
                        <label htmlFor="inputEmail2" className="ul-form__label">
                          Contact Number:
                        </label>
                        <input
                          type="text"
                  ...
                  <div className="card-body">
                    <div className="row">
                      <div className="form-group col-md-4">
                        <label htmlFor="inputtext11" className="ul-form__label">
                          Full Name:
                        </label>
                        <input
                          type="text"
                    ...
                    <div className="row">
                      <div className="form-group col-md-4">
                        <label htmlFor="inputtext14" className="ul-form__label">
                          Contact:
                        </label>
                        <input
                          type="text"
